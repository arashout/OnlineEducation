...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        # I'm going to use a bolean matrix to represent whether the tiles have been cleaned or not
        self.clean_matrix = x = [[False for i in range(self.height)] for j in range(self.width)]
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        #Cast to int so I have proper indexes 
        x = int(pos.getX())
        y = int(pos.getY())
        self.clean_matrix[x][y] = True

...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowercase_lower_bound = ord('a')
        lowercase_upper_bound = ord('z')

        uppercase_lower_bound = ord('A')
        uppercase_upper_bound = ord('Z')

        for letter in string.ascii_lowercase:
            ascii_value = ord(letter) + shift
            if ascii_value > lowercase_upper_bound:
                ascii_value = lowercase_lower_bound + (ascii_value - lowercase_upper_bound) - 1
            shift_dict[letter] = chr(ascii_value)

        for letter in string.ascii_uppercase:
            ascii_value = ord(letter) + shift
            if ascii_value > uppercase_upper_bound:
                ascii_value = uppercase_lower_bound + (ascii_value - uppercase_upper_bound) - 1
            shift_dict[letter] = chr(ascii_value)
        return shift_dict
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.get_message_text():
            if shift_dict.get(letter, False):

...
def playGame(wordList):
    ...
    """
    curHand = dict()
    validGameChoice = ['n', 'r', 'e']
    canPlay = True
    while True:
        gameChoice = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
        if gameChoice in validGameChoice:
            if gameChoice == 'n':
